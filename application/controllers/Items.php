			...
			try {
				      ...
				      $sqlInsert = "INSERT INTO dmar(dma_item_code, dma_item_name, dma_generic_name, dma_item_purch, dma_item_inv, dma_item_sales,
				                    ...
				                    dma_uom_sqty, dma_uom_semb, dma_uom_embqty, dma_tax_sales, dma_acct_type, dma_avprice,dma_uom_weight,dma_uom_umvol,
														dma_uom_vqty, dma_uom_weightn, dma_uom_sizedim,dma_lotes_code, dma_emisionmethod, dma_long_description)VALUES(:dma_item_code,:dma_item_name, :dma_generic_name, :dma_item_purch,
														...
														:dma_uom_sizedim,:dma_lotes_code, :dma_emisionmethod, :dma_long_description)";
          ...
          return;
			...
			try {
				$sqlUpdate = "UPDATE dmar
											...
											dma_long_description = :dma_long_description WHERE dma_id = :dma_id";
