...
class Business extends REST_Controller {
   ...
   //Crear nueva empresa
	public function createCompany_post(){
      ...
      $sqlInsert = "INSERT INTO pgem(pge_name_soc, pge_small_name, pge_add_soc, pge_state_soc, pge_city_soc, pge_cou_soc, pge_id_type, pge_id_soc, pge_web_site, pge_phone1, pge_phone2, pge_cel, pge_branch, pge_mail, pge_curr_first, pge_curr_sys, pge_cou_bank, pge_bank_def, pge_bank_acct, pge_acc_type, pge_bridge_inv,pge_acc_dcp, pge_acc_dcn)
                   VALUES(:Pge_NameSoc, :Pge_SmallName, :Pge_AddSoc, :Pge_StateSoc, :Pge_CitySoc, :Pge_CouSoc, :Pge_IdType, :Pge_IdSoc, :Pge_WebSite, :Pge_Phone1, :Pge_Phone2, :Pge_Cel, :Pge_Branch, :Pge_Mail, :Pge_CurrFirst, :Pge_CurrSys, :Pge_CouBank, :Pge_BankDef, :Pge_BankAcct, :Pge_AccType, :pge_bridge_inv,:pge_acc_dcp, :pge_acc_dcn)";
  ...
  public function updateCompany_post(){
      ...
      $sqlUpdate = "UPDATE pgem SET pge_name_soc = :Pge_NameSoc, pge_small_name = :Pge_SmallName, pge_add_soc = :Pge_AddSoc,
                    ...
                    pge_acc_type = :Pge_AccType, pge_bridge_inv = :pge_bridge_inv, pge_acc_dcp = :pge_acc_dcp, pge_acc_dcn = :pge_acc_dcn WHERE pge_id = :Pge_Id";
