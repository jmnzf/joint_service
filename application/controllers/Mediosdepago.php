...
$resInsert = $this->pedeo->insertRow('INSERT INTO tmdp(mdp_name, mdp_status) VALUES(:mdp_name, :mdp_status)', array(
...
$resUpdate = $this->pedeo->updateRow('UPDATE tmdp SET mdp_name = :mdp_name , mdp_status = :mdp_status  WHERE mdp_id = :mdp_id', array(
'mdp_name' => $Data['mdp_name'], 
'mdp_status' => $Data['mdp_status'], 
'mdp_id' => $Data['mdp_id']));
...
$resSelect = $this->pedeo->queryTable("SELECT mdp_name , mdp_id , CASE  WHEN mdp_status::numeric = 1 THEN 'Activo' WHEN mdp_status::numeric = 0 THEN 'Inactivo' END AS mdp_status FROM tmdp ",array());
