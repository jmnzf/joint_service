...
class NcVenta extends REST_Controller {
	...
	public function NcVenta_post(){
        ...
        //INFORMACION DE LA EMPRESA
	          ...
	          return;
				...
				$sqlcotizacion = "SELECT
													...
													T0.VNC_DUEDATE FechaVenDocumento,
        ...
        <tr>
            <td style="text-align: right;">Descuento: <span>'.$contenidoNcV[0]['monedadocumento']." ".number_format($contenidoNcV[0]['descuento'], 2, ',', '.').'</span></p></td>
        </tr>
				<tr>
