...
class Params extends REST_Controller {
	...
	public function getSiteParams_get(){
		...
		$sqlSelect = "SELECT main_folder, fixrate, coalesce(decimals, 0) as decimals, modular, anuncios, watermarked, textwatermarked, ask_download_language, acc_level, use_tax_art, collection FROM params";
