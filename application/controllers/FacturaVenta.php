...
class FacturaVenta extends REST_Controller {
	...
	public function FacturaVenta_post(){
        ...
        $mpdf = new \Mpdf\Mpdf(['setAutoBottomMargin' => 'stretch','setAutoTopMargin' => 'stretch','default_font' => 'arial']);
			  ...
			  $resrelacionsql = $this->pedeo->queryTable($relacionsql, array(':DVF_DOCENTRY' => $Data));
				...
				if($contenidoFV[0]['regimen'] == '1' OR $contenidoFV[0]['regimen'] == '3'){
					...
					$regimen = '<TABLE width="35%" style="vertical-align: bottom;">
					<TR><TH  style="text-align: left;">BASE DIVISA:</TH>
						<TD style="text-align: left;">'.$contenidoFV[0]['monedadocumento']." ".number_format($valorTotalSubtotal, 2, ',', '.').'</TD>
					<TR><TH  style="text-align: left;">% DE IGTF:</TH>
						<TD style="text-align: left;">'.$contenidoFV[0]['dvf_taxigtf'].'</TD>
					<TR><TH style="text-align: left;">IMPUESTO DIVISA:</TH>
						<TD style="text-align: left;">'.$contenidoFV[0]['monedadocumento']." ".number_format(($valorTotalSubtotal * $contenidoFV[0]['dvf_taxigtf']) / 100, 2, ',', '.').'</TD>
				</TABLE>';
        ...
        <tr class="">
          ...
          <th class="border_bottom">DESCRIPCIÓN</th>
						...
						<tr>
								...
								<th>
											<table width="100%">
													...
													<tr>
															<td style="text-align: right;">IGTF: '.$contenidoFV[0]['monedadocumento']." ".number_format(($contenidoFV[0]['tasa_igtf'] * $contenidoFV[0]['dvf_taxigtf']) / 100, 2, ',', '.').'</span></td>
													</tr>
