...
class FacturaCompra extends REST_Controller {
	...
	public function FacturaCompra_post(){
        ...
        <table width="100%">
        <tr>
            <td style="text-align: right;"><b>Base Documento: </b><span>'.$contenidoFC[0]['monedadocumento']." ".number_format($contenidoFC[0]['base'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;"><b>Descuento: </b><span>'.$contenidoFC[0]['monedadocumento']." ".number_format($contenidoFC[0]['descuento'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
				<tr>
        ...
        <tr>
            <td style="text-align: right;"><b>Total: </b><span>'.$contenidoFC[0]['monedadocumento']." ".number_format($contenidoFC[0]['totaldoc'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
