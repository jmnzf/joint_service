...
class PickingCiego extends REST_Controller {
	...
	public function PickingCiego_post(){
        ...
        //INFORMACION DE LA EMPRESA
	          ...
	          return;
				...
				$sqlPickingCiego = "SELECT
                          ...
                          T0.VEM_TRANSPORT TRANSPORTE,
                          T0.VEM_sup_transport sup_transport,
                          T0.VEM_CI CI,
                          T0.VEM_T_VEHICULO t_vehiculo,
                          T0.VEM_PLACA placa,
                          T0.VEM_GUIA GUIA,
                          T0.VEM_OPL OPL
												FROM DVEM t0
        ...
        <table class="bordew" style="width:100%">
			 ...
			 <tr>
				 <th>
					 <p class="fondo">Transportista:</p>
				 </th>
				 <th style="text-align: left;">
					 <p>'.$contenidoEV[0]['t_vehiculo'].'</p>
				 </th>
			 </tr>
       <tr>
				 <th>
					 <p class="fondo">placa:</p>
				 </th>
				 <th style="text-align: left;">
					 <p>'.$contenidoEV[0]['placa'].'</p>
				 </th>
        ...
        <tr>
            <td style="text-align: auto;">SUP. TRANSPORTE: <span class="sub_ray";>'.$contenidoEV[0]['sup_transport'].'</span></p></td>
        </tr>
				<tr>
            <td style="text-align: auto;">CI: <span class="sub_ray";>'.$contenidoEV[0]['ci'].'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: auto;">T.VEHICULO: <span class="sub_ray";>'.$contenidoEV[0]['t_vehiculo'].'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: auto;">PLACA: <span class="sub_ray";>'.$contenidoEV[0]['placa'].'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: auto;">PRECINTOS: <span class="sub_ray";>'.$contenidoEV[0]['guia'].'</span></p></td>
        </tr>
