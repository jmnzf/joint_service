...
class CotizacionPDF extends REST_Controller {
	...
	public function GenerateQuote_post(){
        ...
        //INFORMACION DE LA EMPRESA
	          ...
	          return;
				...
				$sqlcotizacion = "SELECT
												...
												LEFT JOIN DMSD T3 ON T0.DVC_ADRESS = CAST(T3.DMD_ID AS VARCHAR)
        ...
        <tr>
            <td style="text-align: right;">Total: <span>'.$contenidocotizacion[0]['monedadocumento']." ".number_format($contenidocotizacion[0]['totaldoc'], 2, ',', '.').'</span></p></td>
        </tr>
