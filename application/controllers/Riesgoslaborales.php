...
$resInsert = $this->pedeo->insertRow('INSERT INTO narl(arl_name, arl_profit, arl_status) VALUES(:arl_name, :arl_profit, :arl_status)', array(
...
$resUpdate = $this->pedeo->updateRow('UPDATE narl SET arl_name = :arl_name , arl_profit = :arl_profit , arl_status = :arl_status  WHERE arl_id = :arl_id', array(
'arl_name' => $Data['arl_name'], 
'arl_profit' => $Data['arl_profit'], 
'arl_status' => $Data['arl_status'], 
'arl_id' => $Data['arl_id']));
...
$resSelect = $this->pedeo->queryTable("SELECT arl_name , arl_profit , arl_id , CASE  WHEN arl_status::numeric = 1 THEN 'Activo' WHEN arl_status::numeric = 0 THEN 'Inactivo' END AS arl_status FROM narl ",array());
