...
class SalesInv extends REST_Controller
{
	...
	public function updateSalesInv_post()
	{
		...
		if (is_numeric($resUpdate) && $resUpdate == 1) {
			...
			foreach ($ContenidoDetalle as $key => $detail) {
				...
				$sqlInsertDetail = "INSERT INTO vfv1(fv1_docentry, fv1_itemcode, fv1_itemname, fv1_quantity, fv1_uom, fv1_whscode,
								fv1_price, fv1_vat, fv1_vatsum, fv1_discount, fv1_linetotal, fv1_costcode, fv1_ubusiness, fv1_project,
								fv1_acctcode, fv1_basetype, fv1_doctype, fv1_avprice, fv1_inventory, fv1_acciva,fv1_ubication,fv1_lote, fv1_clean_quantity, fv1_codmunicipality)VALUES(:fv1_docentry, :fv1_itemcode, :fv1_itemname, :fv1_quantity,
								:fv1_uom, :fv1_whscode,:fv1_price, :fv1_vat, :fv1_vatsum, :fv1_discount, :fv1_linetotal, :fv1_costcode, :fv1_ubusiness, :fv1_project,
								:fv1_acctcode, :fv1_basetype, :fv1_doctype, :fv1_avprice, :fv1_inventory, :fv1_acciva,:fv1_ubication,:fv1_lote, :fv1_clean_quantity, :fv1_codmunicipality)";
	...
	public function getSalesInvById_get()
	{
		...
		$campos = ",T4.dms_phone1, T4.dms_phone2, T4.dms_cel, t0.dvf_response_dian, t0.dvf_cufe";

		$sqlSelect = self::getColumn('dvfv', 'dvf', $campos, '', $DECI_MALES, $Data['business'], $Data['branch'],0,0,0," AND dvf_docentry = :dvf_docentry");
	...
	public function getSalesInvDetailCopy_get()
	{
		...
		if(isset($resCopyBy[0])){
			if($resCopyBy[0]['dvf_doctype'] == 34){
				...
				$copy = $this->documentcopy->Copy($Data['fv1_docentry'],'dvfv','vfv1','dvf','fv1','gift,clean_quantity');
				...
				$copy = $this->documentcopy->Copy($Data['fv1_docentry'],'dvfv','vfv1','dvf','fv1','gift,detalle_modular::jsonb,clean_quantity');
	...
	public function getDuplicateDt_get()
	{
		...
		if (!isset($Data['fv1_docentry'])) {
			...
			$copy = $this->documentduplicate->getDuplicateDt($Data['fv1_docentry'],'dvfv','vfv1','dvf','fv1','detalle_modular::jsonb,imponible,clean_quantity');
