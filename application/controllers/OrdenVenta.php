...
class OrdenVenta extends REST_Controller {
	...
	public function OrdenVenta_post(){
        ...
        //INFORMACION DE LA EMPRESA
	          ...
	          return;
				...
				$sqlcotizacion = "SELECT
												...
												LEFT JOIN DMSD T3 ON T0.VOV_ADRESS = CAST(T3.DMD_ID AS VARCHAR)
        ...
        <tr>
            <td style="text-align: right;">Descuento: <span>'.$contenidoOV[0]['monedadocumento']." ".number_format($contenidoOV[0]['descuento'], 2, ',', '.').'</span></p></td>
        </tr>
				<tr>
