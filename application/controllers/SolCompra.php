...
class SolCompra extends REST_Controller {
	...
	public function SolCompra_post(){
        ...
        <table width="100%">
        <tr>
            <td style="text-align: right;">Base Documento: <span>'.$contenidosolcompra[0]['monedadocumento']." ".number_format($contenidosolcompra[0]['base'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Descuento: <span>'.$contenidosolcompra[0]['monedadocumento']." ".number_format($contenidosolcompra[0]['descuento'], 2, ',', '.').'</span></p></td>
        </tr>
				<tr>
            <td style="text-align: right;">Sub Total: <span>'.$contenidosolcompra[0]['monedadocumento']." ".number_format($contenidosolcompra[0]['subtotal'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Impuestos: <span>'.$contenidosolcompra[0]['monedadocumento']." ".number_format($contenidosolcompra[0]['iva'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Total: <span>'.$contenidosolcompra[0]['monedadocumento']." ".number_format($contenidosolcompra[0]['totaldoc'], 2, ',', '.').'</span></p></td>
        </tr>
