...
$config['auth_override_class_method']['Payment']['signOff'] = 'none';
$config['auth_override_class_method']['Payment']['getPayment'] = 'none';
...
|
*/
$config['rest_valid_logins'] = ['serpent' => 'serpent'];
