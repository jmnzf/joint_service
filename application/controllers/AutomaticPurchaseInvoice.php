...
class AutomaticPurchaseInvoice extends REST_Controller
{
    ...
    public function createAutomaticPurchaseInvoice_post(){
        ...
        $sqlHeader = "SELECT * FROM tcsn_copy where csn_doctype = 38";
		...
		if ( isset($Data['retention_only']) && $Data['retention_only'] == 1 ) {

			$resRetencion = $this->retencion->UpdateRetencion( $Data, $ContenidoDetalle, 'cfc', 'fc1', $MONEDALOCAL, $TasaDocLoc, $TasaLocSys, $MONEDASYS, $DECI_MALES, $periodo );

			if ( isset($resRetencion['error']) && $resRetencion['error'] == false ){
		...
		if (is_numeric($resInsert) && $resInsert > 0) {
			...
			foreach ($ContenidoDetalle as $key => $detail) {
				...
				$sqlInsertDetail = "INSERT INTO cfc1(fc1_docentry,fc1_itemcode, fc1_itemname, fc1_quantity, fc1_uom, fc1_whscode,
									...
									fc1_ubication,fc1_baseline,ote_code,fc1_tax_base,deducible)VALUES(:fc1_docentry,:fc1_itemcode, :fc1_itemname, :fc1_quantity,
