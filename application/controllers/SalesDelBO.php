...
class SalesDelBO extends REST_Controller
{
	...
	{	
		...
		$DocNumVerificado = $this->documentnumbering->NumberDoc($Data['vem_series'],$Data['vem_docdate'],$Data['vem_duedate']);
		...
		//PROCESO DE TASA
		$dataTasa = $this->tasa->Tasa($Data['vem_currency'],$Data['vem_docdate']);
		...
		if (!isset($resVerificarAprobacion[0])) {
			...
			$aprobacion = $this->aprobacion->validmodelaprobacion($Data,$ContenidoDetalle,'vem','em1',$Data['business'],$Data['branch']);
		...
		if (is_numeric($resInsert) && $resInsert > 0) {
			...
			foreach ($ContenidoDetalle as $key => $detail) {
				...
				$sqlInsertDetail = "INSERT INTO vem1(em1_docentry, em1_itemcode, em1_itemname, em1_quantity, em1_uom, em1_whscode,
									...
									em1_baseline,detalle_modular,em1_tax_base,detalle_anuncio,imponible, em1_codmunicipality)
									...
									:em1_tax_base,:detalle_anuncio,:imponible, :em1_codmunicipality)";
				...
				$resInsertDetail = $this->pedeo->insertRow($sqlInsertDetail, array(
					...
					':em1_codmunicipality' => isset($detail['em1_codmunicipality']) ? $detail['em1_codmunicipality'] : NULL
				));
	...
	public function updateSalesDel_post()
	{
		...
		$sqlUpdate = "UPDATE dvem	SET vem_docdate=:vem_docdate,vem_duedate=:vem_duedate, vem_duedev=:vem_duedev, vem_pricelist=:vem_pricelist, vem_cardcode=:vem_cardcode,
			  						vem_cardname=:vem_cardname, vem_currency=:vem_currency, vem_contacid=:vem_contacid, vem_slpcode=:vem_slpcode,
										...
										vem_adress=:vem_adress, vem_paytype=:vem_paytype ,business = :business,branch = :branch, vem_internal_comments = :vem_internal_comments
		...
		$resUpdate = $this->pedeo->updateRow($sqlUpdate, array(
			...
			':business' => isset($Data['business']) ? $Data['business'] : NULL,
			':branch' => isset($Data['branch']) ? $Data['branch'] : NULL,
			':vem_internal_comments' => isset($Data['branch']) ? $Data['branch'] : NULL,
		...
		if (is_numeric($resUpdate) && $resUpdate == 1) {
			...
			foreach ($ContenidoDetalle as $key => $detail) {
				...
				$sqlInsertDetail = "INSERT INTO vem1(em1_docentry, em1_itemcode, em1_itemname, em1_quantity, em1_uom, em1_whscode,
																			em1_price, em1_vat, em1_vatsum, em1_discount, em1_linetotal, em1_costcode, em1_ubusiness, em1_project,
																			em1_acctcode, em1_basetype, em1_doctype, em1_avprice, em1_inventory,em1_acciva,em1_ubication, em1_codmunicipality)VALUES(:em1_docentry, :em1_itemcode, :em1_itemname, :em1_quantity,
																			:em1_uom, :em1_whscode,:em1_price, :em1_vat, :em1_vatsum, :em1_discount, :em1_linetotal, :em1_costcode, :em1_ubusiness, :em1_project,
																			:em1_acctcode, :em1_basetype, :em1_doctype, :em1_avprice, :em1_inventory, :em1_acciva,:em1_ubication, :em1_codmunicipality)";
	...
	public function getSalesDelDetailCopy_get()
	{
		...
		$copy = $this->documentcopy->Copy($Data['em1_docentry'],'dvem','vem1','vem','em1','detalle_modular::jsonb,imponible');
	...
	public function getSalesDelBySN_get()
	{
		...
		$copyData = $this->documentcopy->copyData('dvem','vem',$Data['dms_card_code'],$Data['business'],$Data['branch']);
	...
	public function getDuplicateFrom_get() {
		...
		$duplicateData = $this->documentduplicate->getDuplicate('dvem','vem',$Data['dms_card_code'],$Data['business']);
	...
	public function getDuplicateDt_get()
	{
		...
		if (!isset($Data['em1_docentry'])) {
			...
			$copy = $this->documentduplicate->getDuplicateDt($Data['em1_docentry'],'dvem','vem1','vem','em1','detalle_modular::jsonb,imponible');
