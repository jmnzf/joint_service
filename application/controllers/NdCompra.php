	...
	public function NdCompra_post(){
        ...
        //INFORMACION DE LA EMPRESA
	          ...
	          return;
				...
				$sqlcotizacion = "SELECT
												...
												LEFT JOIN DMSD T3 ON T0.CND_cardcode = T3.DMD_card_code AND t3.dmd_ppal = 1
        ...
        <tr>
            ...
            <th>
                ...
                <p class="">'.$contenidoNdC[0]['numerodocumento'].'</p>
        ...
        <table width="100%">
        <tr>
            <td style="text-align: right;">Base Documento: <span>'.$contenidoNdC[0]['monedadocumento']." ".number_format($contenidoNdC[0]['base'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Descuento: <span>'.$contenidoNdC[0]['monedadocumento']." ".number_format($contenidoNdC[0]['descuento'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
				<tr>
            <td style="text-align: right;">Sub Total: <span>'.$contenidoNdC[0]['monedadocumento']." ".number_format($contenidoNdC[0]['subtotal'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Impuestos: <span>'.$contenidoNdC[0]['monedadocumento']." ".number_format($contenidoNdC[0]['iva'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Total: <span>'.$contenidoNdC[0]['monedadocumento']." ".number_format($contenidoNdC[0]['totaldoc'], $DECI_MALES, ',', '.').'</span></p></td>
        </tr>
