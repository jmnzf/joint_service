...
// print_r($sqlcotizacion);exit();die();
				...
				foreach ($contenidoOC as $key => $value) {
					...
					$detalle = '<td>'.$value['conteo'].'</td>
                      ...
                      <td>'.number_format($value['ac1_debit_sys'], $DECI_MALES, ',', '.').'</td>
                      <td>'.number_format($value['ac1_credit_sys'], $DECI_MALES, ',', '.').'</td>';
				 ...
				 $totales = '
										...
										<th>&nbsp;</th>
										<th><b>total:</b></th>
										<th><b>'.number_format($totaldebsys, $DECI_MALES, ',', '.').'</b></th>
										<th><b>'.number_format($totalcresys, $DECI_MALES, ',', '.').'</b></th>
										</tr>';
        ...
        $html = '
				...
				<tr>
					...
					<td></td>
					<td><b>fecha contabilizacion:</b> <span>'.$contenidoOC[0]['mac_legal_date'].'</span></p></td>
				</tr>
				<tr>
				...
				<tr>
					<td><b>fecha documento:</b> <span>'.$contenidoOC[0]['mac_doc_date'].'</span></p></td>
					<td></td>
