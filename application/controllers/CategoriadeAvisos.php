...
$resSelect = $this->pedeo->queryTable("SELECT bca_name , bca_id , CASE  WHEN bca_status::numeric = 1 THEN 'Activo' WHEN bca_status::numeric = 0 THEN 'Inactivo' END AS bca_status FROM tbca ",array());
