...
class SalidaInv extends REST_Controller {
	...
	public function SalidaInv_post(){
        ...
        //INFORMACION DE LA EMPRESA
	          ...
	          return;
				...
				$sqlSalidaInv = "SELECT
                                        ...
                                        WHERE T0.isi_DOCENTRY = :ISI_DOCENTRY";

				$ContenidoSalidaInv = $this->pedeo->queryTable($sqlSalidaInv,array(':ISI_DOCENTRY'=>$Data));
				...
				// print_r($ContenidoSalidaInv);exit();die();
        ...
        <table width="100%">
        <tr>
            <td style="text-align: right;">Base Documento: <span>'.$ContenidoSalidaInv[0]['monedadocumento']." ".number_format($ContenidoSalidaInv[0]['base'], 2, ',', '.').'</span></p></td>
        </tr>

				<tr>
            <td style="text-align: right;">Sub Total: <span>'.$ContenidoSalidaInv[0]['monedadocumento']." ".number_format($ContenidoSalidaInv[0]['subtotal'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Impuestos: <span>'.$ContenidoSalidaInv[0]['monedadocumento']." ".number_format($ContenidoSalidaInv[0]['iva'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Total: <span>'.$ContenidoSalidaInv[0]['monedadocumento']." ".number_format($ContenidoSalidaInv[0]['totaldoc'], 2, ',', '.').'</span></p></td>
        </tr>
