...
class EntradaCompra extends REST_Controller {
	...
	public function EntradaCompra_post(){
        ...
        <table width="100%">
        <tr>
            <td style="text-align: right;">Base Documento: <span>'.$contenidoEC[0]['monedadocumento']." ".number_format($contenidoEC[0]['base'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Descuento: <span>'.$contenidoEC[0]['monedadocumento']." ".number_format($contenidoEC[0]['descuento'], 2, ',', '.').'</span></p></td>
        </tr>
				<tr>
            <td style="text-align: right;">Sub Total: <span>'.$contenidoEC[0]['monedadocumento']." ".number_format($contenidoEC[0]['subtotal'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Impuestos: <span>'.$contenidoEC[0]['monedadocumento']." ".number_format($contenidoEC[0]['iva'], 2, ',', '.').'</span></p></td>
        </tr>
        <tr>
            <td style="text-align: right;">Total: <span>'.$contenidoEC[0]['monedadocumento']." ".number_format($contenidoEC[0]['totaldoc'], 2, ',', '.').'</span></p></td>
        </tr>
