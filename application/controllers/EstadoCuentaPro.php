	...
	public function EstadoCuentaPro_post(){
        ...
        //   print_r($sqlestadocuenta);exit();die();
				...
				foreach ($contenidoestadocuenta as $key => $value) {
					// code...
					$detalle = '
											<td style="border-bottom: dotted;padding-top: 10px;">'.$value['tipo'].'</td>
											...
											<td style="border-bottom: dotted;padding-top: 10px;">'.$value['comentario_asiento'].'</td>
				 ...
				 $total_valores = '
							 ...
							 <th>&nbsp;</th>
							 <th><b>Total</b></th>
							 <th style="width: 10%;" class=" centro"><b>'.$Data['currency'].' '.number_format(($total_saldo), $DECI_MALES, ',', '.').'</b></th>
							 <th>&nbsp;</th>
							 <th>&nbsp;</th>
							 <th>&nbsp;</th>
							 <th>&nbsp;</th>
							 <th class=" centro"><b>'.$Data['currency'].' '.number_format($detail_0_30, $DECI_MALES, ',', '.').'</b></th>
							 <th class=" centro"><b>'.$Data['currency'].' '.number_format($detail_30_60, $DECI_MALES, ',', '.').'</b></th>
							 <th class=" centro"><b>'.$Data['currency'].' '.number_format($detail_60_90, $DECI_MALES, ',', '.').'</b></th>
							 <th class=" centro"><b>'.$Data['currency'].' '.number_format($detail_mayor_90, $DECI_MALES, ',', '.').'</b></th>
							 </tr>';
