...
class AutomaticSalesInvoice extends REST_Controller
{
	...
	public function createAutomaticSalesInvoice_post()
	{
        ...
        $sqlDetail = "SELECT * FROM csn1 WHERE sn1_docentry = :sn1_docentry";
        ...
        foreach ( $resHeader as $key => $element ) {
            ...
            $Data = array(
				...
				'dvf_comment' => $element['csn_comment'],
				...
				'dvf_doctype' => 5,
				'dvf_idadd' => $element['csn_idadd'],
				'dvf_adress' => $element['csn_adress'],
				...
				'dvf_totalretiva' =>  0,
				'dvf_bankable' => 0,
				'dvf_internal_comments'  =>  $element['csn_comment']
            );


            $resDetail = $this->pedeo->queryTable($sqlDetail, array(":sn1_docentry" => $element['csn_docentry']));
