...
class PurchaseDc extends REST_Controller {
...
// CREAR DEVOLUCION EN COMPRAS
    	public function createPurchaseDc_post(){
          ...
          if(!is_array($ContenidoDetalle)){
              $respuesta = array(
                'error' => true,
                'data'  => array(),
                'mensaje' =>'No se encontro el detalle de la devolucion'
              );
         ...
         if(is_numeric($resInsert) && $resInsert > 0){
                 ...
                 if(is_numeric($resInsertDetail) && $resInsertDetail > 0){
                     ...
                     // se retorna el error y se detiene la ejecucion del codigo restante.
                       ...
                       $respuesta = array(
                         'error'   => true,
                         'data' => $resInsert,
                         'mensaje'	=> 'No se pudo registrar la devolucion'
                       );
           ...
           $this->pedeo->trans_commit();
            ...
            $respuesta = array(
              'error' => false,
              'data' => $resInsert,
              'mensaje' =>'Devolucion registrada con exito'
            );
      ...
      //ACTUALIZAR DEVOLUCION EN COMPRA
      public function updatePurchaseDc_post(){
          ...
          $sqlUpdate = "UPDATE dcdc	SET cnc_docdate=:cnc_docdate, cnc_duedate=:cnc_duedate, cnc_duedev=:cnc_duedev,
          ...
          if(is_numeric($resUpdate) && $resUpdate == 1){
    									...
    									if(is_numeric($resInsertDetail) && $resInsertDetail > 0){
    											...
    											// se retorna el error y se detiene la ejecucion del codigo restante.
    												...
    												$respuesta = array(
    													'error'   => true,
    													'data' => $resInsert,
    													'mensaje'	=> 'No se pudo actualizar la devolucion'
    												);
                ...
                $respuesta = array(
                  'error' => false,
                  'data' => $resUpdate,
                  'mensaje' =>'Devolucion actualizada con exito'
                );
      ...
      //OBTENER DEVOLUCION EN COMPRAS
      public function getPurchaseDc_get(){

            $sqlSelect = " SELECT * FROM dcdc ";
      ...
      //OBTENER DEVOLUCION EN COMPRA POR ID
    	public function getPurchaseDcById_get(){
    				...
    				$sqlSelect = " SELECT * FROM dcdc  WHERE cnc_docentry =:cnc_docentry";
      ...
      //OBTENER DEVOLUCION EN COMPRA DETALLE POR ID
      public function getPurchaseDcDetail_get(){
