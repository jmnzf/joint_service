...
$resInsert = $this->pedeo->insertRow('INSERT INTO napp(app_doctype, app_docnum, app_name, app_lastname, app_mail, app_seecolillas) VALUES(:app_doctype, :app_docnum, :app_name, :app_lastname, :app_mail, :app_seecolillas)', array(
...
$resUpdate = $this->pedeo->updateRow('UPDATE napp SET app_doctype = :app_doctype , app_docnum = :app_docnum , app_name = :app_name , app_lastname = :app_lastname , app_mail = :app_mail , app_seecolillas = :app_seecolillas  WHERE app_id = :app_id', array(
'app_doctype' => $Data['app_doctype'], 
'app_docnum' => $Data['app_docnum'], 
'app_name' => $Data['app_name'], 
'app_lastname' => $Data['app_lastname'], 
...
$resSelect = $this->pedeo->queryTable("SELECT nadc.adc_name AS app_doctype, app_docnum , app_name , app_lastname , app_mail , CASE  WHEN app_seecolillas::numeric = 1 THEN 'Si ' WHEN app_seecolillas::numeric = 0 THEN 'No' END AS app_seecolillas, app_id  FROM napp LEFT JOIN nadc ON napp.app_doctype::numeric = nadc.adc_id ",array());
