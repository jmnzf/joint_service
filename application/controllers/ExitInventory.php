...
class ExitInventory extends REST_Controller {
	...
	public function createExitInventory_post(){
      ...
      if(!is_array($ContenidoDetalle)){
        ...
        $resInsert = $this->pedeo->insertRow($sqlInsert, array(
                              ...
                              ':isi_pricelist' => is_numeric($Data['dvc_pricelist'])?$Data['dvc_pricelist']:0,
                              ':isi_cardcode' => isset($Data['isi_cardcode'])?$Data['isi_cardcode']:NULL,
                              ':isi_cardname' => isset($Data['isi_cardname'])?$Data['isi_cardname']:NULL,
                              ':isi_contacid' => is_numeric($Data['isi_contacid'])?$Data['isi_contacid']:0,
                              ':isi_slpcode' => is_numeric($Data['dvc_cardcode'])?$Data['dvc_cardcode']:NULL,
                              ':isi_empid' => is_numeric($Data['isi_empid'])?$Data['isi_empid']:NULL,
                              ...
                              ':isi_discprofit' => is_numeric($Data['dvc_cardcode'])?$Data['dvc_cardcode']:NULL,
                              ...
                              ':isi_doctype' => is_numeric($Data['dvc_cardcode'])?$Data['dvc_cardcode']:NULL,
                              ':isi_idadd' => is_numeric($Data['isi_idadd'])?$Data['isi_idadd']:NULL,
                              ':isi_adress' => isset($Data['isi_adress'])?$Data['isi_adress']:NULL,
                              ':isi_paytype' => is_numeric($Data['dvc_cardcode'])?$Data['dvc_cardcode']:NULL,
                              ':isi_attch' => $this->getUrl(count(trim(($Data['isi_attch']))) > 0 ? $Data['isi_attch']:NULL, $resMainFolder[0]['main_folder'])
                              ':isi_series' => is_numeric($Data['isi_series'])?$Data['isi_series']:NULL,
                              ':isi_createby' => is_numeric($Data['isi_createby'])?$Data['isi_createby']:NULL,
        ...
        if(is_numeric($resInsert) && $resInsert > 0){
          ...
          foreach ($ContenidoDetalle as $key => $detail) {
                ...
                $sqlInsertDetail = "INSERT INTO isi1 (si1_docentry, si1_itemcode, si1_itemname, si1_quantity, si1_uom, si1_whscode, si1_price, si1_vat, si1_vatsum,
                                    si1_discount, si1_linetotal,si1_costcode, si1_ubusiness,si1_project, si1_acctcode, si1_basetype, si1_doctype, si1_avprice,
                                    si1_inventory, si1_id, si1_linenum, si1_acciva)
                                    VALUES
                                    (:si1_docentry, :si1_itemcode, :si1_itemname, :si1_quantity, :si1_uom, :si1_whscode, :si1_price, :si1_vat, :si1_vatsum,
                                     :si1_discount, :si1_linetotal,:si1_costcode, :si1_ubusiness,:si1_project, :si1_acctcode, :si1_basetype, :si1_doctype,
                                     :si1_avprice, :si1_inventory, :si1_id, :si1_linenum, :si1_acciva)";
                ...
                $resInsertDetail = $this->pedeo->insertRow($sqlInsertDetail, array(
                                    ...
                                    ':si1_acctcode' => isset($detail['si1_acctcode'])?$detail['si1_acctcode']:NULL,
                                    ...
                                    ':si1_id' => is_numeric($detail['si1_id'])?$detail['si1_id']:0,
                                    ':si1_linenum' => is_numeric($detail['si1_linenum'])?$detail['si1_linenum']:0,
                                    ':si1_acciva'=> isset($detail['si1_acciva'])?$detail['si1_acciva']:NULL
                ));
  ...
  //ACTUALIZAR ENTRADA
  public function updateExitInventory_post(){
      ...
      $sqlUpdate = "UPDATE misi	SET isi_docnum 	= :isi_docnum ,
																		isi_docdate 	= :isi_docdate ,
																		isi_duedate 	= :isi_duedate ,
																		isi_duedev 	= :isi_duedev ,
																		isi_pricelist 	= :isi_pricelist ,
																		isi_cardcode 	= :isi_cardcode ,
																		isi_cardname 	= :isi_cardname ,
																		isi_contacid 	= :isi_contacid ,
																		isi_slpcode 	= :isi_slpcode ,
																		isi_empid 	= :isi_empid ,
																		isi_comment 	= :isi_comment ,
																		isi_doctotal 	= :isi_doctotal ,
																		isi_baseamnt	= :isi_baseamnt,
																		isi_taxtotal 	= :isi_taxtotal ,
																		isi_discprofit 	= :isi_discprofit ,
																		isi_discount 	= :isi_discount ,
																		isi_createat 	= :isi_createat ,
																		isi_baseentry 	= :isi_baseentry ,
																		isi_basetype 	= :isi_basetype ,
																		isi_doctype 	= :isi_doctype ,
																		isi_idadd 	= :isi_idadd ,
																		isi_adress 	= :isi_adress ,
																		isi_paytype 	= :isi_paytype ,
																		isi_attch 	= :isi_attch ,
																		isi_series 	= :isi_series ,
																		isi_createby 	= :isi_createby ,
																		isi_currency	= :isi_currency
																		WHERE isi_docentry = :isi_docentry";
      ...
      $resUpdate = $this->pedeo->updateRow($sqlUpdate, array(
															...
															':isi_duedate ' => $this->validateDate($Data['isi_duedate'])?$Data['isi_duedate']:NULL,
															':isi_duedev ' => $this->validateDate($Data['isi_duedev'])?$Data['isi_duedev']:NULL,
															':isi_pricelist ' => isset($Data['isi_pricelist'])?$Data['isi_pricelist']:NULL,
															':isi_cardcode ' => isset($Data['isi_cardcode'])?$Data['isi_cardcode']:NULL,
															':isi_cardname ' => isset($Data['isi_cardname'])?$Data['isi_cardname']:NULL,
															':isi_contacid ' => is_numeric($Data['isi_contacid'])?$Data['isi_contacid']:0,
															...
															':isi_comment ' => isset($Data['isi_comment'])?$Data['isi_comment']:NULL,
															':isi_doctotal ' => is_numeric($Data['isi_doctotal'])?$Data['isi_doctotal']:0,
															':isi_baseamnt' => is_numeric($Data['isi_baseamnt'])?$Data['isi_baseamnt']:0,
															':isi_taxtotal ' => is_numeric($Data['isi_taxtotal'])?$Data['isi_taxtotal']:0,
															':isi_discprofit ' => is_numeric($Data['isi_discprofit'])?$Data['isi_discprofit']:0,
															':isi_discount ' => is_numeric($Data['isi_discount'])?$Data['isi_discount']:0,
															':isi_createat ' => $this->validateDate($Data['isi_createat'])?$Data['isi_createat']:NULL,
															':isi_baseentry ' => is_numeric($Data['isi_baseentry'])?$Data['isi_baseentry']:0,
															':isi_basetype ' => is_numeric($Data['isi_basetype'])?$Data['isi_basetype']:0,
															':isi_doctype ' => is_numeric($Data['isi_doctype'])?$Data['isi_doctype']:0,
															':isi_idadd ' => isset($Data['isi_idadd'])?$Data['isi_idadd']:NULL,
															':isi_adress ' => isset($Data['isi_adress'])?$Data['isi_adress']:NULL,
															':isi_paytype ' => is_numeric($Data['isi_paytype'])?$Data['isi_paytype']:0,
															':isi_attch ' => $this->getUrl(count(trim(($Data['isi_attch']))) > 0 ? $Data['isi_attch']:NULL, $resMainFolder[0]['main_folder']),
															':isi_series ' => is_numeric($Data['isi_series'])?$Data['isi_series']:0,
															':isi_createby ' => is_numeric($Data['isi_createby'])?$Data['isi_createby']:0,
															':isi_currency' => isset($Data['isi_currency'])?$Data['isi_currency']:NULL,
      ...
      if(is_numeric($resUpdate) && $resUpdate == 1){
						...
						$this->pedeo->queryTable("DELETE FROM isi1 WHERE isi_docentry=:isi_docentry", array(':isi_docentry' => $Data['isi_docentry']));

						foreach ($ContenidoDetalle as $key => $detail) {

									$sqlInsertDetail = "INSERT INTO isi1 (si1_docentry, si1_itemcode, si1_itemname, si1_quantity, si1_uom, si1_whscode, si1_price, si1_vat,
                                      si1_vatsum,si1_discount, si1_linetotal,si1_costcode,si1_ubusiness,si1_project, si1_acctcode, si1_basetype, si1_doctype,
                                      si1_avprice, si1_inventory,si1_id, si1_linenum, si1_acciva)
	                                    VALUES
	                                    (:si1_docentry, :si1_itemcode, :si1_itemname, :si1_quantity, :si1_uom, :si1_whscode, :si1_price, :si1_vat, :si1_vatsum,
                                       :si1_discount,:si1_linetotal,:si1_costcode, :si1_ubusiness,:si1_project, :si1_acctcode, :si1_basetype, :si1_doctype,
									...
									$resInsertDetail = $this->pedeo->insertRow($sqlInsertDetail, array(
																		':si1_docentry'  => $Data['isi_docentry'],
																		':si1_itemcode' => isset($detail['si1_itemcode'])?$detail['si1_itemcode']:NULL,
																		':si1_itemname' => isset($detail['si1_itemname'])?$detail['si1_itemname']:NULL
																		':si1_quantity' => is_numeric($detail['si1_quantity'])?$detail['si1_quantity']:0,
																		':si1_uom' => isset($detail['si1_uom'])?$detail['si1_uom']:NULL,
